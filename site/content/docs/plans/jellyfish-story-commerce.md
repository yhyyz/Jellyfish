...
| 任务 ID | 内容                                                                                                                                                          | 状态     |
| ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- |
| T23-1   | 5 个平台预设（抖音 / 快手 / 小红书 / YouTube Shorts / TikTok），覆盖尺寸（9:16 / 1:1 / 16:9）/ 时长上限 / 字幕规则 / 结尾水印 / 平台特定贴纸                   | ✅ 已落地 |
| T23-2   | 导出任务：`task_kind = commerce_export`，slow queue，输出落到 `FileUsageKind.PRODUCT_EXPORT`；详见 architecture/commerce-export.md                            | ✅ 已落地 |
